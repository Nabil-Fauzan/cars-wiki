...
class CarPolicy
{
    ...
    {
        return $authUser->hasAnyRole(['admin', 'super_admin']) || $authUser->can('ViewAny:Car');
    }

    public function view(AuthUser $authUser, Car $car): bool
    {
        return $authUser->hasAnyRole(['admin', 'super_admin']) || $authUser->can('View:Car');
    }

    public function create(AuthUser $authUser): bool
    {
        return $authUser->hasAnyRole(['admin', 'super_admin']) || $authUser->can('Create:Car');
    }

    public function update(AuthUser $authUser, Car $car): bool
    {
        return $authUser->hasAnyRole(['admin', 'super_admin']) || $authUser->can('Update:Car');
    }

    public function delete(AuthUser $authUser, Car $car): bool
    {
        return $authUser->hasAnyRole(['admin', 'super_admin']) || $authUser->can('Delete:Car');
    }
